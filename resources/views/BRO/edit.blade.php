                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Edit Buku Rincian Objek</h4>
                            </div>
                            <div class="header-action">
                                {{-- {{ Breadcrumbs::render('rekening.edit') }} --}}

                            </div>
                        </div>
                        <form method="post" action="{{ route('buku_rincian_objek.update', $bukuRincianObjek->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputdate"
                                        value="{{ $bukuRincianObjek->tanggal }}" name="tanggal">
                                </div>
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="No Bukti" name="no_bukti"
                                        ...
                                        value="{{ $bukuRincianObjek->no_bukti }}">
                                    @error('no_bukti')
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" id="ls_formatted" class="form-control" placeholder="LS"
                                        ...
                                        value="{{ formatRupiah($bukuRincianObjek->ls) }}">
                                    <input type="hidden" id="ls" name="ls"
                                        value="{{ $bukuRincianObjek->ls }}">
                                    @error('ls')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" id="gu_formatted" class="form-control" placeholder="UP/GU/TU"
                                        ...
                                        value="{{ formatRupiah($bukuRincianObjek->gu) }}">
                                    <input type="hidden" id="gu" name="gu"
                                        value="{{ $bukuRincianObjek->gu }}">
                                    @error('gu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" id="saldo_formatted" class="form-control" placeholder="Saldo"
                                        ...
                                        value="{{ formatRupiah($bukuRincianObjek->saldo) }}">
                                    <input type="hidden" id="saldo" name="saldo"
                                        value="{{ $bukuRincianObjek->saldo }}">
                                    @error('saldo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
